...
DROP DATABASE IF EXISTS tracker_expenses_dotnet_dev;
...
DROP DATABASE IF EXISTS tracker_expenses_dotnet_test;
...
CREATE DATABASE tracker_expenses_dotnet_dev;
...
CREATE DATABASE tracker_expenses_dotnet_test;